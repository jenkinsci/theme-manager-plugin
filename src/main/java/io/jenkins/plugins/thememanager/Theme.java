 ...
 * <p>
 * Initialise it with {@link Theme#builder()}
 */
public class Theme {
    ...
    public static class Builder {
         ...
         * 
         * <p>It is recommended that you serve the CSS file with Jenkins so that users
         * update the theme by updating the plugin.</p>
         * 
         * <p>There is a convenience method {@link ThemeManagerFactory#getCssUrl()},
         * which will determine the full url if you follow the convention:
         * {@code $JENKINS_URL/theme-$themeId/theme.css}.</p>
         * 
         * <p>The {@code theme.css} suffix can be changed by overriding
         * {@link ThemeManagerFactoryDescriptor#getThemeCssSuffix()}.</p>
         * 
         ...
         * The URL must be absolute (i.e. not just contain the path)
         *
         * <p>It is recommended that you serve the JavaScript file with Jenkins so that users
         * update the theme by updating the plugin.</p>
         *
         * <p>There is a convenience method {@link ThemeManagerFactory#getJavaScriptUrl()},
         * which will determine the full url if you follow the convention:
         * {@code $JENKINS_URL/theme-$themeId/theme.js}.</p>
         *
         * <p>The {@code theme.css} suffix can be changed by overriding
         * {@link ThemeManagerFactoryDescriptor#getThemeJsSuffix()}.</p>
         *
