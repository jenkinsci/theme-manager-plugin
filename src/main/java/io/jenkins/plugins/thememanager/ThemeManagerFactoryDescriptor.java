...
public abstract class ThemeManagerFactoryDescriptor extends Descriptor<ThemeManagerFactory> {
   ...
   * 
   * This should be all lower case and URL safe,
   * i.e. 'dark', 'neo2'
   * 
   * The ID can be re-used inside of your plugin if you are serving multiple variations
   * of the theme, i.e. 'Dark', 'Dark (System)' could both be 'dark'.
   * 
